...
`--env <name>` selects the environment profile (env `APPO_ENV`), and
`--json` prints the raw API response body.
...
| Command | What it does |
| --- | --- |
| `appo new --url <u> [--name <n>]` | Create an app — name defaults from the URL |
