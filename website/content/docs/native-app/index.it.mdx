...
Quando crei un'app — dalla [CLI](/cli) (`appo new`), dal [server MCP](/mcp), dalla [dashboard Appo](https://goappo.io) o da un plugin di piattaforma — Appo genera un'app mobile nativa che carica il tuo sito web all'interno di una WebView. Il livello nativo collega le funzionalità del dispositivo — notifiche push, biometria, fotocamera, posizione e altro — al tuo codice JavaScript attraverso un protocollo basato su messaggi.
