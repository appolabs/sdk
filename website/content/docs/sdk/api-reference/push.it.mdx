...
Si attiva quando l'utente tocca una notifica, sia per l'avvio caldo (app in background) che per l'avvio freddo (app terminata). Ascolta sul canale evento `push.response`.
